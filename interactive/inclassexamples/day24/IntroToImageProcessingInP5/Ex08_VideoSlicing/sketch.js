...
function draw() {
  ...
  if (capture.pixels.length > 0) {
    ...
    s1.image(capture,0,0,160,120,      0,0,160,120);
    s2.image(capture,0,0,160,120,      160,0,160,120);
    s3.image(capture,0,0,160,120,      0,120,160,120);
    s4.image(capture,0,0,160,120,      160,120,160,120);
