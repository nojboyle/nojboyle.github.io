...
let words = ['Hello, world!', 'Pokemon are cool', 'I like p5', 'Hello NYU Students', 'Interactive Computing', 'I am a robot', 'Take me to your leader.', "That's all, folks"];
...
function mousePressed() {
  myVoice.speak("Hello, NYU Students!")
}
